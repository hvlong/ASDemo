...
# hide the original source fileIdentity name.
...
# The remainder of this fileIdentity is identical to the non-optimized version
# of the Proguard configuration fileIdentity (except that the other fileIdentity has
